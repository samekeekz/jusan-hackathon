    ...
    return (
        <div className="bg-white flex flex-col items-center w-[850px] pt-[66px] pb-[133px] px-[90px] rounded-[20px]">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-full flex flex-col">
                ...
                <p className="text-[#979797] leading-8 cursor-pointer mb-36">Мы отправим ссылку с временным паролем на Вашу почту</p>
                <Button className="mb-4 self-center px-20">Восстановить</Button>
            </form>
        </div>
    )
}
