  ...
  return (
    <div className="flex h-full max-w-[83rem] justify-between mx-auto items-center">
      <div className="flex flex-col gap-[120px]">
        <div>
          <h1 className="text-[#333333] text-[75px] font-bold leading-[97px]">
            Тайный Санта
          </h1>
          <p className="text-[#333333] text-[30px] leading-[34px]">
